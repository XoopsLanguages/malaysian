...
define('_TZ_GMTM11', '(GMT-11:00) Pulau Midway, Samoa');
define('_TZ_GMTM10', '(GMT-10:00) Hawaii');
define('_TZ_GMTM9', '(GMT-9:00) Alaska');
define('_TZ_GMTM8', '(GMT-8:00) Waktu Pasifik (AS & Kanada)');
define('_TZ_GMTM7', '(GMT-7:00) Waktu Pergunungan (AS & Kanada)');
define('_TZ_GMTM6', '(GMT-6:00) Waktu Tengah (AS & Kanada), Mexico City');
define('_TZ_GMTM5', '(GMT-5:00) Waktu Timur (AS & Kanada), Bogota, Lima, Quito');
define('_TZ_GMTM4', '(GMT-4:00) Waktu Atlantik (Kanada), Caracas, La Paz');
...
define('_TZ_GMTM1', '(GMT-1:00) Azores, Kepulauan Cape Verde');
define('_TZ_GMT0', '(GMT) Greenwich Mean Time, London, Dublin, Lisbon, Casablanca, Monrovia');
define('_TZ_GMTP1', '(GMT+1:00) Amsterdam, Berlin, Rom, Copenhagen, Brussels, Madrid, Paris');
define('_TZ_GMTP2', '(GMT+2:00) Athens, Istanbul, Minsk, Helsinki, Jerusalem, Afrika Selatan');
...
define('_TZ_GMTP8', '(GMT+8:00) Beijing, Perth, Singapura, Hong Kong, Urumqi, Taipei');
...
define('_TZ_GMTP11', '(GMT+11:00) Magadan, Kepulauan Solomon, New Caledonia');
define('_TZ_GMTP12', '(GMT+12:00) Auckland, Wellington, Fiji, Kamchatka, Pulau Marshall');
