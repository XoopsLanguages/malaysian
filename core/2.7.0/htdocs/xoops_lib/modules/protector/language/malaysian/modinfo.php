...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined($constpref . '_LOADED')) {
    ...
    define($constpref . '_FILE_DOTDOTDSC', 'It eliminates ".." f f all requests loPHoo like Directory Traversals');
    ...
    define($constpref . '_OPT_NONE', 'None (only logginnn');
    ...
    define($constpref . '_DOSOPT_NONE', 'None (only logginnn');
