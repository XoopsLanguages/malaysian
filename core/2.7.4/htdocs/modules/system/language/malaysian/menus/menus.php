...
define('MENUS_HOME', 'Laman Utama');
define('MENUS_ADMIN', 'Pentadbiran');
define('MENUS_ACCOUNT', 'Akaun');
define('MENUS_ACCOUNT_EDIT', 'Edit Akaun');
define('MENUS_ACCOUNT_LOGIN', 'Log Masuk');
define('MENUS_ACCOUNT_LOGOUT', 'Log Keluar');
define('MENUS_ACCOUNT_REGISTER', 'Daftar');
define('MENUS_ACCOUNT_MESSAGES', 'Mesej');
define('MENUS_ACCOUNT_NOTIFICATIONS', 'Pemberitahuan');
define('MENUS_ACCOUNT_TOOLBAR', 'Bar Alat');
